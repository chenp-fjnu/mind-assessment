...
const wechsler = require('./wechsler');
const big5 = require('./big5');
const pf16 = require('./pf16');
const sds = require('./sds');
const sas = require('./sas');
const gad7 = require('./gad7');
const dass21 = require('./dass21');
const epq = require('./epq');
const holland = require('./holland');

...
check('trend 数值型 首次值', tn.firstValue === 120)
check('trend 数值型 最近值', tn.lastValue === 130)
check('trend 数值型 区间差', tn.lastValue - tn.firstValue === 10)
...
check('trend 类型型 首次', tc.firstSummary === 'INFP')
check('trend 类型型 最近', tc.lastSummary === 'ESTJ')

...
Page({
  data: {
    sources: [
      ...
      { name: 'EPQ-RSC 艾森克人格问卷', desc: '简式中文版，含 E / N / P / L 四测评表' },
      { name: 'RIASEC 霍兰德职业兴趣', desc: '现实/研究/艺术/社会/企业/常规六型理论' },
      { name: 'Hendrick & Hendrick 爱情态度测评表', desc: 'LAS，浪漫/好友/游戏/占有/实用/奉献六型' },
      { name: 'MBTI 类型指标', desc: '迈尔斯-布里格斯，公开题库整理（EI/SN/TF/JP）' },
      { name: 'GAD-7 / DASS-21', desc: '广泛性焦虑测评表、抑郁-焦虑-压力测评表' },
      { name: 'Zung 自评测评表', desc: 'SAS 焦虑自评、SDS 抑郁自评（Zung 原版条目）' },
      { name: 'Rosenberg 自尊测评表', desc: 'SES，10 题自尊测量' },
